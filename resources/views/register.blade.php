      ...
      <div class="card-body">
        <form id="register_form" action="{{route ('userRegistration')}}" autocomplete="off" method="POST">
          ...
          <div class="form-check" style="margin-bottom: 20px;">
            <input type="checkbox" class="form-check-input" id="t&c" name="t&c">
            <label class="form-check-label" for="t&c">I agree with terms & conditions</label>
          </div>
          @if ($errors->has('t&c'))
          <div class="form-row">
             <span class="text-danger">The Terms & Condition must be accpeted</span>
          </div>
