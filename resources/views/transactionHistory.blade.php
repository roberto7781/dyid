...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css('css/transactionHistoryStyle.css'))}}">
      ...
      <div class="collapse navbar-collapse order-sm-last" id="ftco-nav">
        ...
        <ul class="navbar-nav " style="margin-left: auto;">
          ...
          <li class="nav-item"><a href="#" class="nav-link logoutBtn"><i class="fa fa-sign-in" aria-hidden="true"></i>
              Login</a></li>
          <li class="nav-item"><a href="./register.html" class="nav-link logoutBtn"><i class="fa fa-user-plus"
                aria-hidden="true"></i>
              Register</a></li>
        </ul>
      </div>
